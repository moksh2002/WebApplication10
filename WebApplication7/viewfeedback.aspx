...
&nbsp;
  ...
  <a class="navbar-brand" href="#"><h3>Admin Page</h3></a><br /><br />
            ...
            <asp:Button ID="Button6" runat="server" Text="Add SubProduct" BackColor="DodgerBlue" BorderStyle="Solid" BorderWidth="3px" Height="32px" Width="251px" OnClick="Button6_Click"  />
                ...
                <asp:Button ID="Button9" runat="server" BackColor="DodgerBlue" Text="View User feedback" BorderStyle="Solid" BorderWidth="3px" Height="32px" Width="251px" Font-Underline="True"  />
          
               </nav></div>
          <center> <div class="col-md-1"  style="height:300px;width:80%;  ">
            <asp:GridView ID="GridView1" runat="server" Height="272px"  Width="392px" CellPadding="3" GridLines="Vertical" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
