<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="whyinsurance.aspx.cs" Inherits="WebApplication7.whyinsurance" %>
...
<h3>1.) Insurance Keeps Commerce Moving</h3>
        ...
        <center><h1>Types of Insurance</h1> </center>
</div>

 

    <hr class="featurette-divider">
<div class="row featurette m-lg-5">
<div class="col-md-7">
<h2 class="featurette-heading">Life Insurance </h2>
<p class="lead">
<b>
...
<h2 class="featurette-heading">Health Insurance </h2>
<p class="lead">
<b>
...
<hr class="featurette-divider">
    ...
    <div class="row featurette m-lg-5">
<div class="col-md-7">
<h2 class="featurette-heading">Travel Insurance </h2>
<p class="lead">
<b>
...
<div class="col-md-5 ">
<img class="bd-placeholder-img m-lg-5  bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="300" height="300" src="3.jpeg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#eee"></rect><text x="50%" y="50%" fill="#aaa" dy=".3em"></text></svg>
...
<div class="row featurette m-lg-5">
<div class="col-md-7 order-md-2">
<h2 class="featurette-heading">Home Insurance </h2>
<p class="lead">
<b>
...
<div class="col-md-5 order-md-1">
<img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="300" height="300" src="4.jpeg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#eee"></rect><text x="50%" y="50%" fill="#aaa" dy=".3em"></text></img>
...
<hr class="featurette-divider ">
    ...
    <div class="row featurette m-lg-5">
<div class="col-md-7">
<h2 class="featurette-heading"> Motor Insurance </h2>
<p class="lead">
<b>
...
<div class="col-md-5 ">
<img class="bd-placeholder-img m-lg-5  bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="300" height="300" src="5.jpeg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#eee"></rect><text x="50%" y="50%" fill="#aaa" dy=".3em"></text></img>
...
<hr class="featurette-divider">
    ...
    <div class="row featurette m-lg-5">
<div class="col-md-7 order-md-2">
<h2 class="featurette-heading"> Miscellaneous Insurance </h2>
<p class="lead">
<b>
...
<div class="col-md-5 order-md-1">
<img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="300" height="300" src="6.jpeg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#eee"></rect><text x="50%" y="50%" fill="#aaa" dy=".3em"></text></img>
